...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="imagenet", choices=["imagenet", "cifar100"], help="choose the dataset")
    parser.add_argument("--checkpoint", type=str, default=None, help="path to checkpoint to validate (optional - creates fresh model if not provided)")
    ...
    parser.add_argument("--learning_rate", type=float, default=1e-6, help="Learning rate (for fresh model)")
    parser.add_argument("--reg_scale", type=float, default=0.5, help="Regularization scale (for fresh model)")
    ...
    parser.add_argument("--accelerator", type=str, default="gpu", help="Validation accelerator: 'cpu', 'gpu', etc.")
    parser.add_argument("--test", action="store_true", help="Run on test set instead of validation set")
